...
const TutorialsList: React.FC = () => {
  ...
  const [timeResponse, setTimeResponse] = useState<any>("");
  ...
  const findTimeByTitle = () => {
    TutorialDataService.findTimeByTitle(searchTitle)
      .then((response: any) => {
        // setTutorials(response.data);
        // setCurrentTutorial(null);
        // setCurrentIndex(-1);
        setTimeResponse(response.data);
        console.log(response.data);
      })
      .catch((e: Error) => {
        console.log(e);
